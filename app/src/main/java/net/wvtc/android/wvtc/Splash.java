...
public class Splash extends Activity implements ActionBar.TabListener {
    ...
    public static class DummySectionFragment extends Fragment {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        synchronized (not) {
                            ...
                            String play =  NoPlaying();
                            not.notify(context,play,0);
                        }
        ...
        public String NoPlaying () {

                    URL url;
                    try {
                        HttpClient httpclient = new DefaultHttpClient(); // Create HTTP Client
                        HttpGet httpget = new HttpGet("http://wvtc.net/now_playing.php"); // Set the action you want to do
                        ...
                        mResults += reader.readLine(); // Result is here

                        is.close();
                    }
                    catch (Exception e){
                        Log.e("WVTC","WVTC Excep" + e.toString());

                    }


            mResults = (mResults.substring(mResults.indexOf(":") + 1));
            return mResults;
